...
- `glua_ls` on global PATH — the plugin launches the project-local binary directly from the project root; never have contributors add a project-specific `.tools/bin` to their permanent PATH.
